...
param = {'D1':0.1,'D2':1.0,'D3':2.0,'D4':0.0,'D5':0.0,'T_ref':0.0,'T_fus':1.0,'pp_ref':0.00001}

model = {'LibraryPath':'../../src/src/libBehaviour.so',
         'Law':'DuctileDamageIndicator_JohnsonCook1985',
         'Hypothesis':'Axisymmetrical'}

data = {'FolderFiles':'../../tests/results/ant10_tensile/',
        'PrefixFiles':'ant10_10_tensile_gauss_points',
        'Components':{'Stress':'SIG','EquivalentPlasticStrain':'P','Temperature':'P'},
        'DataType':'Points',
